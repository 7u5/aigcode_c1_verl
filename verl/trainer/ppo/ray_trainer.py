...
class RayPPOTrainer:
    ...
    def _validate(self):
        ...
        for test_data in self.val_dataloader:
            # Create DataProto from test_data
            test_batch = DataProto.from_single_dict(test_data)

            # Adjust for preference pair data
            if "prompt" in test_batch.batch and "pos_response" in test_batch.batch:
                # Use prompt as input_ids and pos_response as response for validation
                test_batch.batch["input_ids"] = test_batch.batch.pop("prompt")
                test_batch.batch["attention_mask"] = test_batch.batch.pop("prompt_mask")
                test_batch.batch["responses"] = test_batch.batch.pop("pos_response")
                test_batch.batch["response_mask"] = test_batch.batch.pop("pos_mask")
                # Remove unused fields
                test_batch.batch.pop("neg_response", None)
                test_batch.batch.pop("neg_mask", None)
                test_batch.batch.pop("difficulty_coeff", None)
            ...
            # Skip model-based reward models
