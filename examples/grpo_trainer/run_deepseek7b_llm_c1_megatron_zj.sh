...
math_train_path=$HOME/.cache/huggingface/hub/datasets--lmsys--chatbot_arena_conversations/snapshots/1b6335d42a1d2c7e34870c905d03ab964f7f2bd8/data/train-00000-of-00001-cced8514c7ed782a.parquet
...
python3 -m verl.trainer.main_aigcode_c1 --config-path=config \
    ...
    data.dataset_name="lmsys/chatbot_arena_conversations" \
    ...
    trainer.experiment_name="deepseek_llm_7b_chatbot_megatron_$TIME_NOW" \
